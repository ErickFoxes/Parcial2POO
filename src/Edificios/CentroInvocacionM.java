 ...
 * @author Erick Leones
 */
public class CentroInvocacionM  implements Edificios{
    private int madera,mana,pocimas,vida,maderaMax,manaMax,pocimasMax,estado=-3;
    String nombre="CentroInvocacionM";
    @Override
    ...
    public String toString() {
        ...
        return "Centro invocador: Recursos: vida: "+life+" Estado:"+estadoE;
    }
    @Override
