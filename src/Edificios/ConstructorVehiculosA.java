 ...
 * @author Erick Leones
 */
public class ConstructorVehiculosA  implements Edificios{
  private int sangre,sacrificios,oro,vida,sangreMax,sacrificiosMax,oroMax,estado=-5;
  String nombre="ConstructorVehiculosA";
    @Override
