 ...
 * @author Erick Leones
 */
public class ProductorPocimas  implements Edificios{
   private int madera,mana,pocimas,vida,maderaMax,manaMax,pocimasMax,estado=-2;
   String nombre="ProductorPocimas";
    @Override
    ...
    public String toString() {
        ...
        return "Productor de pocimas: Recursos: Pocimas: "+pocimas+" vida: "+life+" Estado:"+estadoE;
    }
