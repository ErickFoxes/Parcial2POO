 ...
 * @author Erick Leones
 */
public class ConstructorVehiculosM  implements Edificios{
    private int madera,mana,pocimas,vida,maderaMax,manaMax,pocimasMax,estado=-5;
    String nombre="ConstructorVehiculosM";
    @Override
